      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
        ...
        <div className="flex items-center gap-4 flex-wrap">
            ...
            <select value={departmentFilter} onChange={(e) => setDepartmentFilter(e.target.value)} className="p-2 border border-brand-border bg-brand-bg rounded-md shadow-sm text-sm min-w-[200px]">
             ...
             <button className="px-4 py-2 bg-gradient-to-r from-brand-accent-purple to-brand-accent-indigo text-white font-semibold rounded-lg shadow-md hover:shadow-lg hover:shadow-brand-accent-indigo/20 transition-all flex items-center gap-2">
