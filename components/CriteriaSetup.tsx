    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto p-4 md:p-6">
      ...
      <div className="lg:col-span-2 bg-brand-card backdrop-blur-sm border border-brand-border rounded-xl p-6">
        ...
        <div className="flex gap-2 items-center">
          ...
          />
          <button onClick={handleAddFactor} className="px-4 py-2 bg-gradient-to-r from-brand-accent-cyan to-brand-accent-blue text-white font-semibold rounded-lg shadow-md flex items-center gap-2">
