        ...
        <div className="text-center py-20 bg-brand-card border border-brand-border rounded-xl">
            ...
            <div className="mt-8 flex justify-center gap-4">
                <button 
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-brand-accent-blue to-brand-accent-purple text-white font-semibold rounded-lg shadow-md flex items-center gap-2 hover:shadow-lg hover:shadow-brand-accent-purple/20 transition-all"
                >
            ...
            <div className="flex justify-between items-center">
                ...
                {employees.length > 0 && (
                     <div className="flex gap-4">
                        ...
                        <button 
                            onClick={handleOpenAddModal}
                            className="px-4 py-2 bg-gradient-to-r from-brand-accent-blue to-brand-accent-purple text-white font-semibold rounded-lg shadow-md flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-brand-accent-purple/20 transition-all"
                        >
